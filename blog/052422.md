...
## Being a student at 42 👨‍🎓

And there it is — the admission email comes in...and you (hopefully) got in! **What now?**

Well...now there's the Holy Graph to tackle. It is divided into 2 big areas: an inner and an outer circle which stand, respectively, for the mandatory cursus - the common core - and the many specializations. From here on out, the rhythm is not as intensive as in the piscine, and remote work is much more common (although one still has to be present for the project evaluations, of course). You will deepen knowledge in C, then tranition into C++; there are some modules on how the internet works, network administration, Docker...and finally, a full-stack project. Seems fun, right? 🤸🏻‍♂️

There are deadlines, though — from the very beginning of the cursus (the kick-off! 🦵), every student is assigned a deadline to submit projects. The first one activates a two month deadline (which is more than enough!), and one can extend the deadline by successfully submitting projects. In fact, this is just a simple measure to promote activity during the curriculum and prevent absenteeism. We estimate that, in average, the common core takes between 8 and 18 months to finish. From then on, a student is required to have an internship at a company (either one of our partners, or not!) — a paid internship, mind you! —, at which point the student can return to the school to pursue a specialization. 

However, throughout the whole cursus one is encouraged to follow one's interests; as you can see from the blog, I'm doing plenty of code outside the curriculum.
